<template>
    <b-modal v-model="showModal" hide-footer title="Import Schools" header-class="p-3 bg-light" size="lg" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
                        ...
                        <div class="text-center">
                            ...
                            <div class="p-2 mt-4">
                                <form @submit.prevent="preview" enctype="multipart/form-data">
                                    ...
                                    <center v-if="users.length > 0"><span class="text-muted mb-4">Are you sure you want to import the <span class="font-weight-bold text-danger"> {{ users.length }}</span> schools?</span></center>
                                    <br />
...
export default {
    ...
    methods : {
        ...
        preview(){
            ...
            axios.post(this.currentUrl + '/schools', data)
            .then(response => {
        ...
        sync(){
            ...
            axios.post(this.currentUrl + '/schools', {
